...
public class LDAPConfig {
    ...
    public  MultivaluedHashMap<String, String> config;
...
//    static {
//        config.add(LDAPConstants.USERS_DN, "OU=Personel,OU=Users And Computers,OU=OSEM,OU=_ORGANIZATION,DC=trs,DC=local");
//        config.add(USER_OBJECT_CLASSES, "user");
//        config.add(UUID_LDAP_ATTRIBUTE, "objectGUID");
//        config.add(USERNAME_LDAP_ATTRIBUTE, "SamAccountName");
//        config.add(RDN_LDAP_ATTRIBUTE, "SamAccountName");
//    }
    ...
    public Collection<String> getUserObjectClasses() {
        String objClassesCfg = config.getFirst(USER_OBJECT_CLASSES);
    ...
    public String getUuidLDAPAttributeName() {
        String uuidAttrName = config.getFirst(UUID_LDAP_ATTRIBUTE);
    ...
    public String getUsernameLdapAttribute() {
        String username = config.getFirst(USERNAME_LDAP_ATTRIBUTE);
        if (username == null) {
